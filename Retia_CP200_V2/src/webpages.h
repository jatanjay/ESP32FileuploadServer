...
<html lang="en">
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
      ...
      // Add the first disabled option based on the file list
  ...
  <html lang="en">
  	...
  	<body>
  		...
  		<div class="container">
  			<div class="upload-box">
                ...
                <button type="submit" class="button-upload" form="format-form" id="submit">Format</button>
                <p>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        button.addEventListener("click", function(event) {
            ...
            formatDetails.textContent = "Formatting...";
            var xhr = new XMLHttpRequest();
...
//     var filesTable = xmlhttp.responseText.trim();
//     var detailsHeader = document.getElementById("detailsheader");
//     var details = document.getElementById("details");

//     if (filesTable === "<table><tr><th align='left'>Name</th><th align='left'>Size</th><th></th><th></th></tr></table>") {
//         // If no files are present, display the table and message
//         detailsHeader.innerHTML = "<h3>No Files On System</h3>";
//         details.style.display = "block";
//         details.innerHTML = filesTable;
//     } else {
//         // If files are present, hide the table and display the message
//         detailsHeader.innerHTML = "<h3>Files On System</h3>";
//         details.style.display = "none";
//         details.innerHTML = filesTable; // Clear the table content
//     }
// }
            ...
            function downloadDeleteButton(e, t) {
                ...
                if (t === "delete") {
                    if (confirm("Are you sure you want to delete?")) {
                        ...
                        // If the user clicks Cancel, do nothing or provide feedback as per your requirement
                    }
                }
            }
